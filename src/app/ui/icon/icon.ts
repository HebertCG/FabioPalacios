...
const ICONS: Record<IconName, IconDef> = {
  ...
  gynecologic: {
    paths: ['M12 13.6a4.6 4.6 0 1 0 0-9.2 4.6 4.6 0 0 0 0 9.2z', 'M12 13.6V21', 'M8.6 17.6h6.8'],
  },
  ...
  'sound-on': {
    paths: [
      'M4 9.4h3L12 5v14l-5-4.4H4z',
      'M15.8 9.6a3.8 3.8 0 0 1 0 4.8',
      'M18.4 7a7.4 7.4 0 0 1 0 10',
    ],
  },
